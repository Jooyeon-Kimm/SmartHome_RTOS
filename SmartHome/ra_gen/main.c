...
#include "task.h"
#include "semphr.h"
extern void thread_uart_create(void);
extern TaskHandle_t thread_uart;
extern void thread_adc_create(void);
extern TaskHandle_t thread_adc;
extern void thread_timer_create(void);
extern TaskHandle_t thread_timer;
extern void thread_gpt__create(void);
extern TaskHandle_t thread_gpt_;
extern void thread_button_create(void);
extern TaskHandle_t thread_button;
